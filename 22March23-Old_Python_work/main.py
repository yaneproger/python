...
# print('int(bool(m % n) = ', temp)
# print('m//n = ', m//n)

# print('m//n+temp = ', m//n+temp)
...
# складываем целочисленное деление на 2 и остаток от деления на 2,
# так как за партой 2 человека и нам нужно посчитать 2 го человека,
# если б за партой сидело 3 человека, то вычисляем остаток от деления на 3.
#
#
#

# a = int(input('1-i klass: '))
# b = int(input('2-i klass: '))
# c = int(input('3-i klass: '))


# res1 = (a//2)+(b//2)+(c//2)+a % 2+b % 2+c % 2
...
# i = int(input('poradkoviy nomer :'))
# j = int(input('nomer vagona :'))

# if i == j:
#     print('nevozmojno s4itat')
# else:
#     print('kolichestvo vagonov', j+i-1)
